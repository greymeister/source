...
STR16			BobbyROrderFormText[] = 
{
	...
	L"Заказ Бобби Рэя подтвержден",	// BOBBYR_EMAIL_SUBJECT: e-mail subject and first body line
	L"Доставка в: %s",			// BOBBYR_EMAIL_ORDER_TO: arg = delivery location
	L"Дата заказа: %s",			// BOBBYR_EMAIL_ORDERED_ON: arg = order date
	L"Ожидаемое прибытие: %s",		// BOBBYR_EMAIL_EXPECTED: arg = estimated arrival date
	L"Список заказа:",			// BOBBYR_EMAIL_ITEMIZED
	...
	L"... [список усечен]",		// BOBBYR_EMAIL_TRUNCATED: appended if the body overflows
	L"Заказ подтвержден.",			// BOBBYR_EMAIL_FALLBACK: body shown when the real one is missing
};
